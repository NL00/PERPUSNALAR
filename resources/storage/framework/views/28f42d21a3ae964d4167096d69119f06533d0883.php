<div class="container">
  ...
  <div class="row">
    <div class="col-md-4">
      <img src="/storage/<?php echo e($buku->sampul); ?>" alt="<?php echo e($buku->judul); ?>" width="250" height="400">
    </div>
    <div class="col-md-8">
      <table class="table">
        <tbody>
...
</div><?php /**PATH C:\Users\THE PUNISHER\Desktop\Badaso\e-perpustakaan\resources\views/livewire/peminjam/buku.blade.php ENDPATH**/ ?>